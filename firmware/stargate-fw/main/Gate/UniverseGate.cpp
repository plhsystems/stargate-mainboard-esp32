...
double UniverseGate::LEDIndexToDeg(int32_t s32LedIndex)
{
...
int32_t UniverseGate::ChevronIndexToLedIndex(int32_t s32ChevronNumber)
{
...
int32_t UniverseGate::SymbolToLedIndex(int32_t s32SymbolNumber)
{
...
bool UniverseGate::IsLEDIndexChevron(int32_t s32LedIndex)
{
