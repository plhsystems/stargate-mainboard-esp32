...
void USB_DHD::Init()
{
    ...
    ESP_LOGI(TAG, "Line Get: Rate: %d, Stop bits: %d, Parity: %d, Databits: %d", 
		(int)line_coding.dwDTERate,
        (int)line_coding.bCharFormat, (int)line_coding.bParityType, (int)line_coding.bDataBits);
    ...
    ESP_LOGI(TAG, "Line Set: Rate: %d, Stop bits: %d, Parity: %d, Databits: %d", 
		(int)line_coding.dwDTERate,
		(int)line_coding.bCharFormat, (int)line_coding.bParityType, (int)line_coding.bDataBits);
...
void USB_DHD::Start()
{
	// if (xTaskCreatePinnedToCore(TaskRunning, "USB_DHD", FWCONFIG_USBDHD_STACKSIZE, (void*)this, FWCONFIG_USBDHD_PRIORITY_DEFAULT, &m_sTaskUSBHandle, FWCONFIG_USBDHD_COREID) != pdPASS )
	// {
